...
public class LinkedBinaryTree<E> implements BinaryTree<E> {
   ...
   * @throws EmptyTreeException */
    ...
    checkPosition(v); //your work is here
    return (v == root());
  }
...
// Additional accessor method
  ...
  * @throws EmptyTreeException */
  ...
  public int depth (Tree<E> T, Position<E> v) throws InvalidPositionException, BoundaryViolationException, EmptyTreeException {
  ...
  public int height1 (Tree<E> T) throws InvalidPositionException, EmptyTreeException, BoundaryViolationException {
     int h = 0;
   ...
   public  int height2 (Tree<E> T, Position<E> v) throws InvalidPositionException, BoundaryViolationException {
  ...
  public static void main(String[] args) throws EmptyTreeException, NonEmptyTreeException, InvalidPositionException, BoundaryViolationException {
